...
<tr>
  <td align="center" valign="top" style="padding: 0 20px;">
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr>
        <td align="center" valign="top" >
          <a href="<?php echo($splash_data['preschoolexpansion_text_link_field_3_5']); ?>" ><img class="container" src="<?php echo(preschoolexpansion_theme_image('images/link-img.png')); ?>" width="69" alt="link-img"/></a>
        </td>
      </tr>
      <!-- start space -->
      <tr>

...
function preschoolexpansion_api_init() {
  ...
  add_settings_section(
          'preschoolexpansion_splash_page_editor_section', __('Splash Page Editor', 'preschoolexpansion_textdomain'), 'preschoolexpansion_splash_page_editor_section', 'preschoolExpansionSplashEditor'
  );

  // Add the field with the names and function to use for our settings
  // and put in in our section
  add_settings_field(
          'preschoolexpansion_text_field_0', __('Section 1 Title', 'preschoolexpansion_textdomain'), 'preschoolexpansion_text_field_0_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_textarea_field_1', __('Section 1 Content', 'preschoolexpansion_textdomain'), 'preschoolexpansion_textarea_field_1_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_text_link_field_1_5', __('Section 1 Link', 'preschoolexpansion_textdomain'), 'preschoolexpansion_text_link_field_1_5_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_text_field_2', __('Section 2 Title', 'preschoolexpansion_textdomain'), 'preschoolexpansion_text_field_2_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_textarea_field_3', __('Section 2 Content', 'preschoolexpansion_textdomain'), 'preschoolexpansion_textarea_field_3_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_text_link_field_3_5', __('Section 2 Link', 'preschoolexpansion_textdomain'), 'preschoolexpansion_text_link_field_3_5_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_text_field_4', __('Section 3 Title', 'preschoolexpansion_textdomain'), 'preschoolexpansion_text_field_4_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_textarea_field_5', __('Section 3 Content', 'preschoolexpansion_textdomain'), 'preschoolexpansion_textarea_field_5_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );

  add_settings_field(
          'preschoolexpansion_text_link_field_5_5', __('Section 3 Link', 'preschoolexpansion_textdomain'), 'preschoolexpansion_text_link_field_5_5_render', 'preschoolExpansionSplashEditor', 'preschoolexpansion_splash_page_editor_section'
  );
}
...
// ------------------------------------------------------------------
// Callback functions for our editor field settings. Renders the field 
// and saves with the wordpress settings API
// ------------------------------------------------------------------
//
